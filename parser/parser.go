...
var (
	bpfLexer = stateful.MustSimple([]stateful.Rule{
		...
		{Name: "IPTosMagic", Pattern: `\b(ce|ect1|ect0)\b`, Action: nil},
		...
		{Name: "Match", Pattern: `\b(bytes|packets|port|asn|interface|iface|address|router|country|direction|duration|etype|proto|status|tcpflags|iptos|dsfield|nexthop|netsize|vrf|samplingrate|cid|icmp|bps|pps)\b`, Action: nil},
